...
- (void)EnemyMove:(float)EnemyX
{
    ...
    [self performSelector:@selector(changeAnimation:)withObject:EnemyIV afterDelay:0.5];
   // [self performSelector:@selector(startGIF:)withObject:nil afterDelay:0.3];
    //[self startGIF];
}
    ...
    - (void) startGIF
    {
        CGRect rect = CGRectMake(85, 320, 150, 200);
